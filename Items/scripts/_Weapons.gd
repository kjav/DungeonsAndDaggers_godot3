class Unarmed extends "WeaponBase.gd":
	func _init():
...
class CommonSword extends "WeaponBase.gd":
	func _init():
...
class CommonShield extends "WeaponBase.gd":
...
class CommonSpear extends "WeaponBase.gd":
...
class CommonBow extends "WeaponBase.gd":
