...
func setup_params():
	...
	npc_distribution = IndependentDistribution.new([
		{ "p": 1, "value": Constants.Enemies.Storage, "position": Vector2(1,1) },
		{ "p": 1, "value": Constants.Enemies.Storage, "position": Vector2(1,2) },
		{ "p": 1, "value": Constants.Enemies.Storage, "position": Vector2(1,3) },
		{ "p": 1, "value": Constants.Enemies.Storage, "position": Vector2(1,4) },
		{ "p": 1, "value": Constants.Enemies.Storage, "position": Vector2(1,5) },
